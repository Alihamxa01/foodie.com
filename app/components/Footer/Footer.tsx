    ...
    <footer  className=" h-screen bg-gradient-to-tr from-orange-500 to-amber-900 text-white py-10 border-t-8 border-y-yellow-950">
      <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p>Fast and reliable delivery to your door. We offer delivery services across the city. Enjoy our delicious food at the comfort of your home.</p>
        </div>

        {/* Contact Us Section */}
        <div>
          <h2 id="about" className="text-lg font-bold mb-4">Contact Us</h2>
